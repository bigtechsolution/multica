...
INSERT INTO agent_task_queue (
    ...
    trigger_summary, force_fresh_session, is_leader_task, routing_decision
)
VALUES (
    ...
    COALESCE(sqlc.narg('routing_decision')::jsonb, '{}'::jsonb)
)
RETURNING *;
...
INSERT INTO agent_task_queue (agent_id, runtime_id, issue_id, status, priority, context, routing_decision)
VALUES ($1, $2, NULL, 'queued', $3, $4, COALESCE(sqlc.narg('routing_decision')::jsonb, '{}'::jsonb))
RETURNING *;
